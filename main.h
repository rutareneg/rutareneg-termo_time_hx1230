...
//#define lcd_DC       GPIO_Pin_9// не используется
#define lcd_RST      GPIO_Pin_8//
#define lcd_SCE	     GPIO_Pin_7//
#define lcd_MOSI     GPIO_Pin_15//  MOSI--D16
#define lcd_SCLK     GPIO_Pin_13// SCK--D15
#define lcd_LED      GPIO_Pin_12//  не используется
...
#define  pos_mday	0,8,8    //У,Х, размер шрифта
#define  pos_mon	0,26,8    //У,Х, размер шрифта
#define  pos_year   0,44,8    //У,Х, размер шрифта
#define  pos_dn  	0,72,8    //У,Х, размер шрифта

#define  pos_hour   1,2,24    //У,Х, размер шрифта
#define  pos_min    1,50,24    //У,Х, размер шрифта
#define  pos_sec    1,82,8    //У,Х, размер шрифта
